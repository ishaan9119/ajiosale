...
import ajiosale.reader.mycomponent.MyStreamReaderImpl
import ajiosale.transformer.mycomponent.MyStreamTransformerImpl
import ajiosale.writer.mycomponent.MyStreamWriterImpl
